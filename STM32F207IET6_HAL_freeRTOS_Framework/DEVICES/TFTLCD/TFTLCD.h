...
#define	LCD_CS_CLR  GPIOB->BSRR=1<<(6+15)     //片选端口  	PB6
#define	LCD_RS_CLR	GPIOB->BSRR=1<<(5+15)     //数据/命令  	PB5	   
#define	LCD_WR_CLR	GPIOB->BSRR=1<<(4+15)     //写数据		PB4
#define	LCD_RD_CLR	GPIOB->BSRR=1<<(3+15)     //读数据		PB3
#define	LCD_RST_CLR	GPIOB->BSRR=1<<(7+15)     //复位		PB7	
